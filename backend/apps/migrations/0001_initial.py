    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bgColor', models.CharField(default='rgb(249 115 22 / var(--tw-bg-opacity))', max_length=30)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_NoteCategory', to='apps.category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_NoteUser', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Note',
